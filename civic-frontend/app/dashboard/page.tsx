...
export default function DashboardPage() {
  ...
  const [token, setToken] = useState<string | null>(null) // Store token state
        ...
        {sidebarOpen && (
          <aside className="w-64 bg-sky-100 p-6 space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href={`https://clinic-inventory-pmmq.onrender.com/auth?token=${encodeURIComponent(token ?? '')}`}
                  target="_blank"
